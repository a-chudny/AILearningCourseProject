...
describe('Footer', () => {
  ...
  it('renders contact section', () => {
    ...
    expect(screen.getByRole('link', { name: /contact@volunteerportal.org/i })).toHaveAttribute(
      'href',
      'mailto:contact@volunteerportal.org'
    );
    expect(screen.getByRole('link', { name: /\+995 32 212 34 56/i })).toHaveAttribute(
      'href',
      'tel:+995322123456'
    );

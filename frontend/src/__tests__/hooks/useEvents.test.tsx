...
import { useEvents, useEvent, useCreateEvent, useUpdateEvent, useDeleteEvent, useCancelEvent, eventKeys } from '@/hooks/useEvents'
...
describe('useCreateEvent', () => {
  ...
  it('handles create error', async () => {
    ...
    await act(async () => {
      result.current.mutate({ title: 'Test', description: '', location: '', startTime: '', durationMinutes: 60, capacity: 10 })
    })

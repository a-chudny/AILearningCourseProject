    ...
    <div className="space-y-6">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-900 bg-white shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
              </div>
              <div>
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 p-6">
        ...
        <ul className="mt-2 space-y-1 text-sm text-blue-800">
          <li>
            • All exports are in Excel format (.xlsx) and can be opened in any spreadsheet software
          </li>

      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>123 Community Way, Volunteer City, VC 12345</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <a
              href="https://facebook.com/volunteerportal"
              target="_blank"
            ...
            <a
              href="https://twitter.com/volunteerportal"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-blue-600 transition-colors"
              aria-label="Twitter"
            ...
            <a
              href="https://linkedin.com/company/volunteerportal"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-blue-600 transition-colors"
              aria-label="LinkedIn"
